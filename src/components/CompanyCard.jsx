...
const CompanyCard = ({ company, onClick }) => {
  return (
    <div onClick={onClick} className="border-solid border px-5 py-4 m-2 rounded-md border-gray-200 flex-grow cursor-pointer	hover:bg-sky-100 transition ease-in">
